package pro.sky.lesson28skypro.controllers;
...
public class IngredientController {
    ...
    public Ingredients getIngredient(@Valid @PathVariable int id) {
    ...
    public Ingredients editIngredient(@Valid @PathVariable int id, @Valid @RequestBody Ingredients ingredient) {
...
//    или так
    ...
    public ResponseEntity<Ingredients> removeIngredients(@Valid @PathVariable int id){
