...
public class RecipeController {
    ...
    public Recipes getRecipe(@Valid @PathVariable int id) {
    ...
    public Recipes editRecipes(@Valid @PathVariable int id, @Valid @RequestBody Recipes recipes){
...
//    или так
    ...
    ResponseEntity<Recipes> removeRecipe(@Valid @PathVariable int id){
